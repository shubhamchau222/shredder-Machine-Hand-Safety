...
import orien_lines
import datetime
from imutils.video import VideoStream    # installed from pip 
from utils import detector_utils as detector_utils
from datetime import date
import xlrd                       # lib to handle the excel file
from xlwt import Workbook          # lib to handle the excel file
from xlutils.copy import copy       # lib to handle the excel file
import numpy as np
...
detection_graph, sess = detector_utils.load_inference_graph()    # loading the inference graph 

def save_data(no_of_time_hand_detected, no_of_time_hand_crossed):
    '''
         This method will save the information of Hand-detection 
    ...
    try:   
        ...
        rb = xlrd.open_workbook('result.xls')  # reading the excel file 
...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            if im_height == None:
                print('origional shape of frame =  ' , frame.shape)
            ...
            Line_Position2=orien_lines.drawsafelines(frame,Orientation,Line_Perc1,Line_Perc2)  # safety border line
