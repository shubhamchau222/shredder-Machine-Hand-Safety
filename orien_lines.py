# thos file will help to draw twhe safety Lines 
...
def drawsafelines(image_np,Orientation,Line_Perc1,Line_Perc2):
    ...
    if(Orientation=="bt"):
        ...
        Line_Position2=int(image_np.shape[0]*(Line_Perc2/100))  # safety border line red
        ...
        # print(Line_Position2)
        #Line_Position2 = 'Safety border line red'
